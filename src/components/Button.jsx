...
export default function Button({ children, variant = 'primary', className = '', ...props }) {
  ...
  const variants = {
    primary: "bg-brand-blue hover:bg-brand-blue-light text-white shadow-[0_0_20px_rgba(37,99,235,0.25)] border border-brand-blue-light/10",
    secondary: "bg-brand-dark-3 hover:bg-brand-dark-4 text-white border border-white/5 hover:border-white/10",
    outline: "bg-transparent border border-white/10 hover:border-brand-blue text-white hover:text-brand-blue-light",
  }
